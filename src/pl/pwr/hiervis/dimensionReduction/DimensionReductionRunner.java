...
public class DimensionReductionRunner extends Thread
{
	...
	public void run()
	{
		...
		Hierarchy outputHierarchy = dimensionReduction.reduceHierarchy(inputLoadedHierarchy);

		long elapsedTime = System.currentTimeMillis() - start;
		System.out.println("Elapsed Time: " + elapsedTime / (1000F) + " sec");

		context.dimensionReductionCalculated
				.broadcast(new CalculatedDimensionReduction(inputLoadedHierarchy, dimensionReduction, outputHierarchy));
	}

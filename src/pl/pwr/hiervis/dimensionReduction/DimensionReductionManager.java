...
{
	/*Holds all dialogs for dimension reduction methods
	 * Elements need to be manually added after implementation
	*/
	...
	{
		DimensionReduction dimensionReduction = dimensionReductionDialogs.get(index).showDialog(maxOutputDimensions, pointsAmount);
